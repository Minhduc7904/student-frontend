...
const RedoWrongDifficultyStatsCard = ({ byDifficulty }) => {
    ...
    return (
        <Card className="w-full rounded-2xl border-pink-200 p-4">
            <div className="flex h-full flex-col gap-3">
                <p className="text-xs font-semibold uppercase tracking-wide text-pink-600">Theo độ khó</p>
                                ...
                                <button
                                    ...
                                    className={`rounded-full border px-2.5 py-1 text-[11px] font-semibold whitespace-nowrap transition-colors ${
                                        isActive
                                            ...
                                            : "border-pink-200 bg-white text-pink-600 hover:border-pink-300 hover:text-pink-800"
                                    }`}
                                >
                                    {tab.label}
                                </button>
...
export default memo(RedoWrongDifficultyStatsCard);
