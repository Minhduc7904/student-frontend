...
const PracticeByChapterQuestionStatements = ({ statements = [], statementPrefixType }) => {
    ...
    return (
        <div className="mt-4 space-y-3">
            {safeStatements.map((statement, statementIndex) => {
                ...
                return (
                    <div
                        key={statement?.statementId ?? `by-chapter-statement-${statementIndex + 1}`}
...
export default PracticeByChapterQuestionStatements;
