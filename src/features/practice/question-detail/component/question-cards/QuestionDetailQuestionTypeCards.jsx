...
import {
    selectQuestionDetailSubmitAnswerErrorByQuestionId,
    selectQuestionDetailSubmitAnswerLoadingByQuestionId,
    submitQuestionDetailAnswer,
} from '../../store/questionDetailSlice';
import PracticeByChapterQuestionCardBase from '../../../by-chapter/component/question-cards/PracticeByChapterQuestionCardBase';
import {
    getSortedStatements,
    ...
    resolveShortAnswer,
    resolveTrueFalseMap,
} from '../../../by-chapter/component/question-cards/questionUtils';
...
const submitAnswer = (dispatch, payload) => {
    ...
    dispatch(submitQuestionDetailAnswer(payload));
};
...
export const QuestionDetailSingleChoiceQuestionCard = ({ question, index }) => {
    const dispatch = useDispatch();
    const statements = useMemo(() => getSortedStatements(question), [question]);
    const questionId = question?.questionId;
    const submitLoading = useSelector((state) => selectQuestionDetailSubmitAnswerLoadingByQuestionId(state, questionId));
    const submitError = useSelector((state) => selectQuestionDetailSubmitAnswerErrorByQuestionId(state, questionId));
...
export const QuestionDetailTrueFalseQuestionCard = ({ question, index }) => {
    const dispatch = useDispatch();
    const statements = useMemo(() => getSortedStatements(question), [question]);
    const questionId = question?.questionId;
    const submitLoading = useSelector((state) => selectQuestionDetailSubmitAnswerLoadingByQuestionId(state, questionId));
...
export const QuestionDetailShortAnswerQuestionCard = ({ question, index }) => {
    const dispatch = useDispatch();
    const questionId = question?.questionId;
...
export const QuestionDetailGenericQuestionCard = ({ question, index }) => (
