...
const PracticeResultQuestionStatements = ({ statements = [], statementPrefixType }) => {
    ...
    return (
        <div className="mt-3 space-y-2.5">
            {safeStatements.map((statement, statementIndex) => {
                ...
                return (
                    <div
                        key={statement?.statementId ?? `practice-result-statement-${statementIndex + 1}`}
...
export default PracticeResultQuestionStatements;