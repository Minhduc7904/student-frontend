...
const QuestionStatsSummaryDonutCard = ({ summary, fallbackAnswered = 0, fallbackCorrect = 0, fallbackIncorrect = 0 }) => {
    ...
    return (
        <Card className="w-full rounded-2xl border-slate-200 p-4">
            <div className="flex h-full flex-col gap-3">
                <p className="text-xs uppercase text-slate-500">Thống kê câu hỏi</p>
...
export default memo(QuestionStatsSummaryDonutCard);
